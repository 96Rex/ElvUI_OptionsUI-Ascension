...
L["Are you sure you want to reset ActionBars settings?"] = "你确定要重置‘技能栏’的设置吗？"
...
L["Coding:"] = "编码:"
L["Color Keybind Text when Out of Range, instead of the button."] = "当你超过射程时对键位名称着色而不是对按钮着色"
L["Color Keybind Text"] = "键位名称着色"
...
L["Color of the actionbutton when not usable."] = "技能栏按键不可用时的颜色"
L["Color of the actionbutton when out of power (Mana, Rage)."] = true
L["Color of the actionbutton when out of range."] = "当超出距离时技能栏按键的颜色"
L["Color of the actionbutton when usable."] = "技能栏按键可用时的颜色"
...
L["Display bind names on action buttons."] = "在技能栏按钮上显示键位名称"
...
L["Display macro names on action buttons."] = "在技能栏按钮上显示宏名称"
...
L["Equipped Item Color"] = "高亮颜色"
L["Equipped Item"] = "高亮已装备的物品"
...
L["Global Fade Transparency"] = "全局渐隐透明度"
L["Global"] = "全局"
L["Glow"] = "边框发光"
L["Gold Format"] = "金币格式"
L["Good Color"] = "正常颜色"
...
L["If you unlock actionbars then trying to move a spell might instantly cast it if you cast spells on key press instead of key release."] = "如果不锁定技能栏,那么当你试图拖动技能时你可能会在鼠标按下的瞬间施放拖动的技能."
...
L["Inherit the global fade, mousing over, targetting, setting focus, losing health, entering combat will set the remove transparency. Otherwise it will use the transparency level in the general actionbar settings for global fade alpha."] = "继承全局渐隐, 鼠标悬浮、目标、焦点、损失血量、进入战斗会减低不透明度.否则会为全局透明度使用一般技能栏的设置"
L["Inset"] = "插入"
...
L["JustifyH"] = "水平对齐"
L["Key Down"] = "按下施法"
L["Keybind Mode"] = "按键悬浮绑定"
L["Keybind Text Position"] = "按键名称显示位置"
L["Keybind Text X-Offset"] = "按键名称横向偏移"
L["Keybind Text Y-Offset"] = "按键名称纵向偏移"
L["Keybind Text"] = "键位名称"
...
L["Multiply the backdrops height or width by this value. This is usefull if you wish to have more than one bar behind a backdrop."] = "根据此值增加背景的高度或宽度. 一般用来在一个背景框里放置多条技能栏"
L["NPC IDs"] = "NPC ID"
L["Name Color"] = "姓名颜色"
...
L["Restore the actionbars default settings"] = "恢复此技能栏的预设设定"
...
L["Stack Text Position"] = "堆叠数量显示位置"
L["Stack Text X-Offset"] = "堆叠数量横向偏移"
L["Stack Text Y-Offset"] = "堆叠数量纵向偏移"
...
L["The amount of buttons to display."] = "显示多少个技能栏按钮"
L["The button you must hold down in order to drag an ability to another action button."] = "按住修饰键后才能拖动技能栏的按钮"
...
L["The first button anchors itself to this point on the bar."] = "第一个按钮对齐技能栏的方向"
...
L["The size of the action buttons."] = "技能栏按钮尺寸"
...
L["Toggles the display of the actionbars backdrop."] = "切换技能栏显示背景框"
...
L["Transparent Backdrops"] = "背景栏背景透明"
L["Transparent Buttons"] = "按钮背景透明"
L["Transparent"] = "透明"
L["Triggers"] = "触发器"
...
L[ [=[This works like a macro, you can run different situations to get the actionbar to page differently.
 Example: '[combat] 2;']=] ] = [=[和宏写法类似, 能根据不同姿态切换技能栏.
 例如: '[combat] 2;']=]

L[ [=[This works like a macro, you can run different situations to get the actionbar to show/hide differently.
 Example: '[combat] show;hide']=] ] = [=[和宏写法类似, 能根据不同姿态切换技能栏显示或隐藏.
 例如: '[combat] show;hide']=]
